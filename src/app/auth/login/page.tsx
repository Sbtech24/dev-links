    ...
    <div className='p-7 sm:max-w-md mx-auto md:flex md:flex-col  md:gap-4 md:items-center md:justify-center h-screen'>
        ...
        <div className='pt-4 sm:bg-white sm:p-9 rounded-md'>
            ...
            <form action="" className='flex flex-col gap-5'>
                ...
                <input type="password" name="Password" id="" className='input-style text-[#333333]' placeholder='Enter your password' />
                    
                    </div> 
               </label>
                
                <button className='text-white bg-purple w-full p-2 mt-2 mb-1 rounded-md' onClick={RedirectToHome}>Login</button>
            </form>
