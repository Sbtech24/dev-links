        ...
        <div className='pt-4 sm:bg-white sm:p-9 rounded-md'>
            ...
            <form action="" className='flex flex-col gap-5' onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="relative w-full ">
                    {/* <EnvelopeSimpleIcon weight='fill' className="absolute left-3 top-1/2 -translate-y-1/2" size={20} color='#737373'/> */}
                    <input type="email" {...register("email",{required:true})} id="email" className='input-style pl-12 text-[#333333]' placeholder='e.g.alex@email.com'/>  
                </div>
                </label>

                <label htmlFor="password" className='block text-sm text-darkGrey'>Password
                <div className='relative w-full'>
                    {/* <LockKeyIcon weight='fill' className='absolute top-1/2 left-3 -translate-y-1/2' size={20} color='#737373'/> */}
                <input type="password" {...register("password",{required:true,max:8})} id="password" className='h-10 pl-12 input-style text-[#333333]' placeholder='At least .8 Characters' />
                ...
                <div className='relative w-full'>
                    {/* <LockKeyIcon weight='fill' className='absolute top-1/2 left-3 -translate-y-1/2' size={20} color='#737373'/> */}
                <input type="password" {...register("confirmPassword",{required:true,max:8})} id="confirm-password" className='h-10 pl-12 input-style text-[#333333]' placeholder='At least .8 Characters' />
