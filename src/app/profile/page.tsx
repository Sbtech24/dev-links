          ...
          <div className="bg-white p-3 m-2 ">
           ...
           <div className='bg-lightGrey py-4 pr-14 pl-6rounded-lg'>
              <form action=""className='pl-3'>
                <label htmlFor="" className='block text-gray-800 my-3'>First name*
                  <input type="text" className='p-2 w-full rounded-md ' placeholder='Ben' />
                </label>

                <label htmlFor=""className='block text-gray-800 my-3'>Last name*
                  <input type="text" className='p-2 w-full rounded-md' placeholder='Wright' />
                </label>

                <label htmlFor=""className='block text-gray-800 my-3'>Email*
                  <input type="email" placeholder='ben@example.com' className='block p-2 w-full rounded-md' />
                </label>
              </form>
           </div>
