...
const page = () => {
  return (
    <div className='max-w-xs sm:max-w-sm mx-auto p-3'>
        ...
        <div className='pt-4'>
            <h3 className='font-bold pb-2 text-darkGrey'>Login</h3>
            <p className='text-grey pb-2 text-md leading-6 mb-3'>Add your details below to get back into the app</p>
            ...
            <form action="">
                ...
                <label htmlFor="password" className='block text-sm pt-4 text-darkGrey'>Password  
