    ...
    <div className="bg-lightGrey w-3/4 mx-auto pb-3">
        ...
        <form action="">
            <label htmlFor="platform" className='block text-sm p-2 text-grey'>Platform
                <select name="links" id="" className='w-full p-2 border rounded-md my-1' value="">
            ...
            <label htmlFor="link" className='block text-sm p-2 text-grey'>Link 
              <input type="text" name="link" placeholder='Enter Url' id="" className='w-full p-2 border rounded-md'/>
            </label>
        </form>
    </div>
  )
